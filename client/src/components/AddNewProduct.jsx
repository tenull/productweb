    ...
    return ( 
        ...
        <Tr>
            <Td>
                ...
                <Tooltip label={'Set the name of  your second image e.g.,Iphone1.jpg'} fontSize='sm'>
            ...
            <Td>
                ...
                <Input size='sm' value={category} onChange={(e)=>setCategory(e.target.value)} placeholder="s"/>
            ...
            <Text fontSize='sm'>Stock</Text>
                ...
                <FormControl display='flex' alignItems='center'>
                    <FormLabel htmlFor="productIsNewFlag" mb='0' fontSize='sm'>
                        Enable
                        <Badge rounded='full' px='1' mx='1' fontSize='0.8em' colorScheme='green'>new</Badge>
                        badge?
                    </FormLabel>
