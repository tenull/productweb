...
const OrderSummary = ({ checkoutSreen = false }) => {
    ...
    const totalAmount = Math.floor((subtotal - (subtotal * discount)) / 5) * 5;
    ...
    return (
        <Stack
            ...
            {totalAmount < 5000 && (
                <Text color="red.500" textAlign='center' fontSize="sm">*5000 Ft alatt nem tudjuk teljesíteni a kiszállítást</Text>
            )}
            <Button
